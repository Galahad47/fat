...
class MainApp:
    def __init__(self):        
        ...
        self.main = Tk();self.main.title('Перевод из аудио в текст');                                   self.main.geometry('400x700')
        ...
        #Вот тут надо доделать а то фигня
    ...
    def convert(self):
        try:
            ...
            data = model.transcribe(self.data_to_convert,temperature=0.2,condition_on_previous_text=True,fp16=False,verbose=False)
            
            self.converted_text = data["text"]
